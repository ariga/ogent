			...
			case 'u': // Prefix: "users/"
				...
				if idx > 0 {
					...
					case '/': // Prefix: "/best-friend"
						...
						if len(elem) == 0 {
							// Leaf: DeleteUserBestFriend
							s.handleDeleteUserBestFriendRequest([1]string{
								args[0],
							}, w, r)
					...
					if idx > 0 {
						...
						case '/': // Prefix: "/"
							...
							case 'b': // Prefix: "best-friend"
								...
								if len(elem) == 0 {
									// Leaf: CreateUserBestFriend
									s.handleCreateUserBestFriendRequest([1]string{
										args[0],
									}, w, r)
