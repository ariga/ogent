...
// ByRescuerCount orders the results by rescuer count.
func ByRescuerCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newRescuerStep(), opts...)
	}
}

// ByRescuer orders the results by rescuer terms.
func ByRescuer(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newRescuerStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newRescuerStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
