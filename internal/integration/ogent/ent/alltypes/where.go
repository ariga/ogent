...
func And(predicates ...predicate.AllTypes) predicate.AllTypes {
	return predicate.AllTypes(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.AllTypes) predicate.AllTypes {
	return predicate.AllTypes(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.AllTypes) predicate.AllTypes {
	return predicate.AllTypes(sql.NotPredicates(p))
}
